...
const NotesList = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-4xl font-bold text-center mb-8">All Notes</h1>
          ...
          {notes.map(note => (
            ...
            >
              <h2 className="text-2xl font-semibold mb-2">
                <Link to={`/notes/${note._id}`} className="hover:text-blue-500">
                  {note.title}
                </Link>
              </h2>
              <p className="text-gray-700 mb-4">{note.content.substring(0, 70)}...</p>
